        ...
        private void CreateCFGTag()
        {
            ...
            for (int i = 0; i < recordToConvert.AnalogChannelCount; i++)
            {
                XElement analogChannel = new XElement("Analog_Channel",
                    ...
                    new XElement("ID", recordToConvert.GetAnalogChannelID(i)),
                    ...
                    new XElement("Multiplier", recordToConvert.GetAnalogChannelMultipier(i)),
                    new XElement("Offset", recordToConvert.GetAnalogChannelOffset(i)),
                    ...
                    new XElement("Primary_or_Secondary_Indicator", recordToConvert.GetAnalogChannelPrimarySecondaryIndicator(i)));
            ...
            for (int i = 0; i < recordToConvert.DigitalChannelCount; i++)
            {
                XElement digitalChannel = new XElement("Digital_Channel",
                    ...
                    new XElement("ID", recordToConvert.GetDigitalChannelID(i)),
                    new XElement("Phase", recordToConvert.GetDigitalChannelPhase(i)),
                    new XElement("CCBM", recordToConvert.GetDigitalChannelCCBM(i)),
                    new XElement("Normal_State", recordToConvert.GetDigitalChannelNormalState(i)));
