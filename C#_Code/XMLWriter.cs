        ...
        private void CreateCFGTag()
        {
            ...
            for (int i = 0; i < recordToConvert.AnalogChannelCount; i++)
            {
                XElement analogChannel = new XElement("Analog_Channel",
                    new XElement("Index", recordToConvert.analogChannels[i].Index),
                    new XElement("ID", recordToConvert.analogChannels[i].Identifier),
                    new XElement("Phase", recordToConvert.analogChannels[i].Phase),
                    new XElement("CCBM", recordToConvert.analogChannels[i].CCbm),
                    new XElement("Unit", recordToConvert.analogChannels[i].Unit),
                    new XElement("Multiplier", recordToConvert.analogChannels[i].Multiplier),
                    new XElement("Offset", recordToConvert.analogChannels[i].Adder),
                    new XElement("Skew", recordToConvert.analogChannels[i].Skew),
                    new XElement("Min", recordToConvert.analogChannels[i].Min),
                    new XElement("Max", recordToConvert.analogChannels[i].Max),
                    new XElement("Primary_Ratio", recordToConvert.analogChannels[i].Primary),
                    new XElement("Secondary_Ratio", recordToConvert.analogChannels[i].Secondary),
                    new XElement("Primary_or_Secondary_Indicator", recordToConvert.analogChannels[i].P_S));
            ...
            for (int i = 0; i < recordToConvert.DigitalChannelCount; i++)
            {
                XElement digitalChannel = new XElement("Digital_Channel",
                    new XElement("Index", recordToConvert.digitalChannels[i].Index),
                    new XElement("ID", recordToConvert.digitalChannels[i].Identifier),
                    new XElement("Phase", recordToConvert.digitalChannels[i].Phase),
                    new XElement("CCBM", recordToConvert.digitalChannels[i].CCbm),
                    new XElement("Normal_State", recordToConvert.digitalChannels[i].State));
